...
const SESSION_FILE_PATH = './session2.json';
let client;
let sessionData;
...
const inicio = () => {
   ...
   $query_pago = 'SELECT idClientes, tel1, tel2, precio_mensual FROM morosos1 WHERE bloque = 2';
   ...
   connection.query($query_pago, function(err, rows, fields) {
       ...
       client.sendMessage(carlos,'inicia morosos2');
       client.sendMessage(daniel,'inicia morosos2');
       client.sendMessage(esteban,'inicia morosos2');
       client.sendMessage(cam,'inicia morosos2');
       client.sendMessage(celina,'inicia morosos2');
       ...
       client.sendMessage(carlos,'finalizo morosos2');
       client.sendMessage(esteban,'finalizo morosos2');
       client.sendMessage(cam,'finalizo morosos2');
       client.sendMessage(daniel,'finalizo morosos2');
       client.sendMessage(celina,'finalizo morosos2');
   });
