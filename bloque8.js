...
const SESSION_FILE_PATH = './session8.json';
let client;
let sessionData;
...
const inicio = () => {
   ...
   $query_pago = 'SELECT idClientes, tel1, tel2, precio_mensual FROM morosos1 WHERE bloque = 8';
   ...
   connection.query($query_pago, function(err, rows, fields) {
       ...
       client.sendMessage(carlos,'inicia morosos 8');
       client.sendMessage(daniel,'inicia morosos 8');
       client.sendMessage(esteban,'inicia morosos 8');
       client.sendMessage(cam,'inicia morosos 8');
       client.sendMessage(celina,'inicia morosos 8');
       ...
       client.sendMessage(carlos,'finalizo morosos 8');
       client.sendMessage(esteban,'finalizo morosos 8');
       client.sendMessage(cam,'finalizo morosos 8');
       client.sendMessage(daniel,'finalizo morosos 8');
       client.sendMessage(celina,'finalizo morosos 8');
