...
const SESSION_FILE_PATH = './session7.json';
let client;
let sessionData;
...
const inicio = () => {
   ...
   $query_pago = 'SELECT idClientes, tel1, tel2, precio_mensual FROM morosos1 WHERE bloque = 7';
   ...
   connection.query($query_pago, function(err, rows, fields) {
       ...
       client.sendMessage(carlos,'inicia morosos 7');
       client.sendMessage(daniel,'inicia morosos 7');
       client.sendMessage(esteban,'inicia morosos 7');
       client.sendMessage(cam,'inicia morosos 7');
       client.sendMessage(celina,'inicia morosos 7');
       ...
       client.sendMessage(carlos,'finalizo morosos 7');
       client.sendMessage(esteban,'finalizo morosos 7');
       client.sendMessage(cam,'finalizo morosos 7');
       client.sendMessage(daniel,'finalizo morosos 7');
       client.sendMessage(celina,'finalizo morosos 7');
