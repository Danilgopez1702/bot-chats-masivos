...
const SESSION_FILE_PATH = './session3.json';
let client;
let sessionData;
...
const inicio = () => {
   ...
   $query_pago = 'SELECT idClientes, tel1, tel2, precio_mensual FROM morosos1 WHERE bloque = 3';
   ...
   connection.query($query_pago, function(err, rows, fields) {
       ...
       client.sendMessage(carlos,'inicia morosos 3');
       client.sendMessage(daniel,'inicia morosos 3');
       client.sendMessage(esteban,'inicia morosos 3');
       client.sendMessage(cam,'inicia morosos 3');
       client.sendMessage(celina,'inicia morosos 3');
       ...
       client.sendMessage(carlos,'finalizo morosos 3');
       client.sendMessage(esteban,'finalizo morosos 3');
       client.sendMessage(cam,'finalizo morosos 3');
       client.sendMessage(daniel,'finalizo morosos 3');
       client.sendMessage(celina,'finalizo morosos 3');
